...
class System {
  ...
  void addCircle(){
    Circle p = new Circle(new PVector(random(200,500),random(0,height)),new PVector(random(-1,1),random(-1,1)),new PVector(0,0),10.0,10.0);
    circles.add(p);
  }
   
  void addSquare(){
    Square p = new Square(new PVector(random(0,width),noise(0,height)),new PVector(random(-1,1),random(-1,1)),new PVector(0,0),10.0,10.0);
    squares.add(p);
  }
